...
public class ThreadE extends Thread {
    ...
    String humbasNo = "0007961087";

    Map<String, Object> resultData = new HashMap<String, Object>();
    HttpClient httpClient = null;
    HttpPost httpPost = null;
    String result = "";
    String jsonstr = "{\"service\":\"https://mp.fsgplus.com/\",\"tgtId\":\"TGT-28020-rgIebfst9udnZhi7tXsSQF40MyMxY6rKZHuJGCVNylhFQe1PqD-cas01.example.org\"}";
