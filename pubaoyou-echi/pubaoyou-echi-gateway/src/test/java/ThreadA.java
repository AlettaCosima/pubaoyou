...
public class ThreadA extends Thread {
    ...
    String humbasNo = "0001098194";

    Map<String, Object> resultData = new HashMap<String, Object>();
    HttpClient httpClient = null;
    HttpPost httpPost = null;
    String result = "";
    String jsonstr = "{\"service\":\"https://mp.fsgplus.com/\",\"tgtId\":\"TGT-26360-f2xXlUBRWBEfhVOaTVqjPdmZDwOTUPCVO6AbXrcI5lJAB7h99s-cas01.example.org\"}";
