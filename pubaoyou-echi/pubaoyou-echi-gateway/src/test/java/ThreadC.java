...
public class ThreadC extends Thread {
    ...
    String humbasNo = "0001102014";

    Map<String, Object> resultData = new HashMap<String, Object>();
    HttpClient httpClient = null;
    HttpPost httpPost = null;
    String result = "";
    String jsonstr = "{\"service\":\"https://mp.fsgplus.com/\",\"tgtId\":\"TGT-27676-ONm0ucgOflN5xh1McffLNSu5FKzgxIbf6YB9AM5MrJJPUjuEun-cas01.example.org\"}";
