...
public class ThreadB extends Thread {
    ...
    String humbasNo = "0005839469";

    Map<String, Object> resultData = new HashMap<String, Object>();
    HttpClient httpClient = null;
    HttpPost httpPost = null;
    String result = "";
    String jsonstr = "{\"service\":\"https://mp.fsgplus.com/\",\"tgtId\":\"TGT-28048-z9wzDu4TlpWw7iTFg4sc9DoTgAQmYNRlaLcJa2zijA74HuvfRB-cas01.example.org\"}";
